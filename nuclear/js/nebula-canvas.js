...
const src_ruim = 'img/nebula.png';
const src_bom = 'img/nebula_verde.png';
const src_normal = 'img/nebula.jpg';
var atabl = 0.1;
...
$(document).ready(function(){	
	...
	(function ($) {			
			...
			var	Puff = function(p) {				
				var	opacity,
					sy = (Math.random()*2850)>>0,
					sx = (Math.random()*2850)>>0;
				
				this.p = p;
						
				this.move = function(timeFac) {						
					p = this.p + atabl * timeFac;				
			...
			{								
				...
				ctx2.drawImage( $canvas[0] ,0,0,1000,1000);				
				setTimeout(loop, 10 );				
			};
			...
			$(imagem).bind('load',null, function() {  ctx3.drawImage(imagem, 0,0, 570, 570);	loop(); });
			imagem.src = 'img/nebula.jpg';
